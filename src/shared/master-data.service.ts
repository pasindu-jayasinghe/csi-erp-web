export class MasterDataService {
    ...
    private _time_zones: { name: string, value: string }[] = []
    private _activity_status: { name: string, value: string }[] = []
    ...
    constructor() {
        ...
        this.time_zones = [
            ...
            { name: "(GMT +7:30)  Mumbai, Kolkata, Colombo", value: "+07:30" },
    ...
    set activity_status(value: { name: string; value: string }[]) {
        this._activity_status = value;
    }

    get activity_status(): { name: string; value: string }[] {
        return this._activity_status;
    }


    set time_zones(value: { name: string; value: string }[]) {
        this._time_zones = value;
    }

    get time_zones(): { name: string; value: string }[] {
        return this._time_zones;
    }
