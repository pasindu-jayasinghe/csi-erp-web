...
import { ProfileStatus, RecordStatus } from 'src/shared/AppService';
import { AuthControllerServiceProxy, ServiceProxy, AuthCredentialDto } from 'src/shared/service-proxies/service-proxies';
...
export class ResetComponent implements OnInit {
  ...
  async ngOnInit(): Promise<void> {
    ...
    if(resetKey){
      this.email = resetKey;
      const profileState = await this.getProfileState(this.email);
